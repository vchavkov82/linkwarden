    ...
    <>
      ...
      >
        {!isPublicRoute && (
          <input
            type="checkbox"
            className="checkbox checkbox-sm shrink-0 ml-1 mr-1 z-20 opacity-0 group-hover:opacity-100 checked:opacity-100 cursor-pointer"
            checked={isSelected}
        ...
        <div
          className="flex items-center cursor-pointer w-full min-h-[2.75rem] gap-2 min-w-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-inset"
          onClick={() =>
