...
function LinkCard({
  ...
  return (
    <div
      ...
      className={cn(
        "border border-solid border-neutral-content bg-base-200 duration-100 rounded-xl relative group",
        "hover:border-primary/30 hover:bg-base-300",
    ...
    >
      ...
      <div ref={ref} className="h-full">
        <div
          className="rounded-xl cursor-pointer h-full flex flex-col justify-between focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-1"
          onClick={() =>
            !editMode && openLink(link, user, () => setLinkModal(true))
          }
          onKeyDown={(e) => {
            if (e.key === "Enter" && !editMode) {
              openLink(link, user, () => setLinkModal(true));
            }
          }}
          {...listeners}
          {...attributes}
            ...
            <div>
              ...
              >
                {formatAvailable(link, "preview") ? (
                  ...
                  <div
                    className={`bg-base-200 ${imageHeightClass} bg-opacity-80`}
                  ></div>
                ) : (
                  <div
