...
export default function Modal({
  ...
  if (width < 640) {
    ...
    return ReactDOM.createPortal(
      <div
        className="overflow-y-auto pt-2 sm:py-2 fixed top-0 bottom-0 right-0 left-0 bg-neutral/10 backdrop-blur-sm flex justify-center items-center fade-in z-40"
