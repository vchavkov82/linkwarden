  ...
  return (
    <>
      ...
      <div className="flex justify-between gap-2 items-center pl-3 pr-4 py-2 border-solid border-b-neutral-content border-b">
        ...
        >
          <i className="bi-list text-xl leading-none" aria-hidden="true" />
        </Button>
                ...
                <TooltipTrigger asChild>
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      className="hidden sm:inline-flex min-w-[3.4rem] h-11 relative"
                    >
                      <span>
        ...
        {sidebar && (
          <div className="fixed top-0 bottom-0 right-0 left-0 bg-neutral/10 backdrop-blur-sm flex items-center fade-in z-40">
